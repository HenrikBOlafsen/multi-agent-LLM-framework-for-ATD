...
echo "== Starting fake LLM (fail explain forever) =="
start_fake_llm --fail_explain_times -1 --fail_explain_mode http_503
...
echo "== Running LLM (expect: at least one blocked due to explain LLM unavailable) =="
